# Pepa Arm Home Agent
## Sensory Arm for Pepa - AI4Aging.org
...
[![Home Assistant](https://img.shields.io/badge/Home%20Assistant-2026.2.1+-blue.svg)](https://www.home-assistant.io/)
[![HACS](https://img.shields.io/badge/HACS-Custom-orange.svg)](https://hacs.xyz/)

Refactoring of the Home Agent integration (UPSTREAM - https://github.com/aradlein/hass-agent-llm) to 
enhance it for better context management, guardrails, extra tools, A2A/MCP server support, and more for use
in the Pepa AI for Aging project (https://ai4aging.org). **_All documents will be updated as the integration evolves._**
